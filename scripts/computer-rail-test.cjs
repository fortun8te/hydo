...
const shell = stripComments(fs.readFileSync(path.join(ROOT, "src/screens/Shell.jsx"), "utf8"));
const rail = stripComments(fs.readFileSync(path.join(ROOT, "src/screens/ComputerRail.jsx"), "utf8"));
